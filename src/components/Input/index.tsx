...
// React.RefForwardingComponent esse caso só usado quando eu quero pegar uma ref
// do meu form
const Input: React.RefForwardingComponent<inputRef,InputProps> = ({name , icon , containerStyle = {}, ...rest }, ref) => {
  ...
  const handleInputBlur = useCallback(() => {
    setIsFocused(false);
    // quando coloco !! o js faz tipo um if ternario reduzido retornando tru ou false
